...
--登录界面
UIDefine.UILoginLayer = {script = "app.GameUILayer.UILoginLayer", csb = "layer/login/login_register_mail.csb", implent = "app.GameUILayer.UIImplentLogic.LoginLayerImplent"}
